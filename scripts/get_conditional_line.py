...
"""
    ...
    print(f"Line 3 depends on: {get_conditional_lines(test_code1, 3)}")  # Should be [1, 2]
    print(f"Line 5 depends on: {get_conditional_lines(test_code1, 5)}")  # Should be [1, 2]
...
"""
    ...
    print(f"Line 10 depends on: {get_conditional_lines(test_code2, 10)}") # [1]
...
"""
    ...
    print(f"Line 4 depends on: {get_conditional_lines(test_code4, 4)}")   # [1, 2, 3]
